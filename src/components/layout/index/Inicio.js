      ...
      <div>
            ...
            <div className="container-title-btn">
              ...
              <div className="container-btn">
                <button
                  onClick={() => {
                    window.location =
                      "https://play.google.com/store/apps/details?id=ar.com.yoop";
                  }}
                ...
                <img
                  src={logoGooglePlay}
                  className="logoGooglePlay-header"
                  alt=""
                />
              </div>
            </div>
        ...
        <div className="container-comofunciona">
          ...
          <div className="container-pasos">
            <div className="paso-descarga">
              ...
              <p className="description-paso-descarga">
                Descargás la app y te asocias
              </p>
            </div>
            <div className="paso-descarga">
              <img
                src={iconoSmartphoneDesc}
                className="img-paso-descarga"
                alt=""
              />
              <p className="description-paso-descarga">
                Buscás las marcas amigas
              </p>
            </div>
            <div className="paso-descarga">
        ...
        <div className="container-marca-amiga">
          ...
          <div className="img-marca-amiga">
            <img
              src={imgCompra}
              className="img-marcaamiga"
              alt="Imagen Marcas amigas"
            />
          </div>
        </div>
      </div>
